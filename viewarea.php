...
if(isset($_GET["Serial_No"]) && !empty(trim($_GET["Serial_No"])) && isset($_GET["Area_Name"]) && !empty(trim($_GET["Area_Name"]))){
    // Include config file
    require_once "gardendb.php";
    
    // Prepare a select statement
    $sql = "SELECT * FROM plant WHERE Serial_No = ? AND Area_Name=?";
    
    if($stmt = mysqli_prepare($link, $sql)){
        // Bind variables to the prepared statement as parameters
        mysqli_stmt_bind_param($stmt, "is", $param_id, $param_areaname);
        
        // Set parameters
        $param_id = trim($_GET["Serial_No"]);
        $param_areaname = trim($_GET["Area_Name"]);
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="tutorial"><p><b><?php echo $row["Serial_No"]; ?></b></p></div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                    <label><h4>Equipment</h4></label>
                        <div class="tutorial"><p><b><?php echo $row["equipment"]; ?></b></p></div>
