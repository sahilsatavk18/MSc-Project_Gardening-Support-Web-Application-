...
<div class="bg bg3"></div>
    <div class="topnav" id="myTopnav">
      ...
      <form action="area_trial.php" style="border:1px solid #ccc" method="post">
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5">Area Details</h2>
                    <p>Please enter the input values and submit to add the area record.</p>
