...
<form action="output_trial.php" style="border:1px solid #ccc" method="post" enctype="multipart/form-data">
  <div class="container">
    <h1>Garden XYZ</h1><br><br>
    <label for="email"><b>Username</b></label><br>
    <input type="text" placeholder="Enter username" name="username" required>

    <label for="email"><b>Garden Name</b></label><br>
    <input type="text" placeholder="Enter garden name" name="gardenname" required>

    <label for="email"><b>Area Name</b></label><br>
    <input type="text" placeholder="Enter area name" name="areaname" required>
